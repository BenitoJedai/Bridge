namespace ScriptKit.CLR.Html
{
    ...
    public enum EventType
    {
        ...
        /// </summary>
        [ScriptKit.CLR.Name("repeatEvent")]
        RepeatEvent,

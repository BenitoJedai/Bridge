...
namespace ScriptKit.CLR.Html
{
    ...
    {
        [ScriptKit.CLR.Inline("ScriptKit.is({0}, MouseEvent)")]
        public static bool IsMouseEvent(this Event e)
        {
            return false;
        }

        [ScriptKit.CLR.Inline("ScriptKit.is({0}, FocusEvent)")]
        public static bool IsFocusEvent(this Event e)
        {
            return false;
        }

        [ScriptKit.CLR.Inline("ScriptKit.is({0}, UIEvent)")]
        public static bool IsUIEvent(this Event e)
        {
            return false;
        }

        [ScriptKit.CLR.Inline("ScriptKit.is({0}, KeyboardEvent)")]

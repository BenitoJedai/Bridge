namespace ScriptKit.CLR.Html
{
    ...
    public enum FontVariantLigatures
    {
        ...
        /// </summary>
        [ScriptKit.CLR.Name("common-ligatures")]
        CommonLigatures,

        /// <summary>
        /// Disables display of common ligatures (OpenType features: liga, clig).
        /// </summary>
        [ScriptKit.CLR.Name("no-common-ligatures")]
        NoCommonLigatures,
        ...
        /// </summary>
        [ScriptKit.CLR.Name("no-contextual")]
        NoContextual
    }
}

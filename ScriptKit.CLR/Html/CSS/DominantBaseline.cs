...
[ScriptKit.CLR.Name("String")]
    public enum DominantBaseline
    {
        ...
        /// </summary>
        [ScriptKit.CLR.Name("text-after-edge")]
        TextAfterEdge,
        ...
        /// </summary>
        [ScriptKit.CLR.Name("text-before-edge")]
        TextBeforeEdge
    }
}

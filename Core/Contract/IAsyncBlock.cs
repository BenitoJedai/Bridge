...
namespace Bridge.Contract
{
    public interface IAsyncBlock
    {
        ...
        System.Collections.Generic.List<IAsyncStep> EmittedAsyncSteps { get; set; }
        void InitAsyncBlock();
        bool IsParentForAsync(ICSharpCode.NRefactory.CSharp.AstNode child);
        bool IsTaskReturn { get; set; }
        ICSharpCode.NRefactory.CSharp.LambdaExpression LambdaExpression { get; set; }
        ICSharpCode.NRefactory.CSharp.MethodDeclaration MethodDeclaration { get; set; }
        ICSharpCode.NRefactory.CSharp.AstNode Node { get; }
        bool ReplaceAwaiterByVar { get; set; }
        ICSharpCode.NRefactory.TypeSystem.IType ReturnType { get; set; }
        int Step { get; set; }

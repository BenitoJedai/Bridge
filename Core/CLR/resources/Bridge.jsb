...
<project path="" name="Bridge.NET" author="Object.NET, Inc." version="1.0.0" copyright="@version   : 1.0.0 - Bridge.NET&#xD;&#xA;@author    : Object.NET, Inc. http://www.bridge.net/&#xD;&#xA;@date      : 2014-06-01&#xD;&#xA;@copyright : Copyright (c) 2008-2014, Object.NET, Inc. (http://www.object.net/). All rights reserved.&#xD;&#xA;@license   : See license.txt and https://github.com/bridgedotnet/Bridge.NET/blob/master/LICENSE." output="$project" source="False" source-dir="$output\source" minify="False" min-dir="$output" doc="False" doc-dir="$output\docs" master="true" master-file="$output\yui-ext.js" zip="true" zip-file="$output\yuo-ext.$version.zip">
  <file name="Core.js" />

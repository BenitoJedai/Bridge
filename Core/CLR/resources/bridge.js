...
Bridge.Class.generic('Bridge.List$1',function(T){var $$name=Bridge.Class.genericName('Bridge.List$1',T);return Bridge.Class.cache[$$name]||(Bridge.Class.cache[$$name]=Bridge.Class.extend($$name,{$extend:[Bridge.ICollection$1(T)],$init:function(obj){if(Object.prototype.toString.call(obj)==='[object Array]'){this.items=obj;}
...
Bridge.Class.extend('Bridge.AspectAttribute',{$extend:[Bridge.Attribute]});Bridge.Class.extend('Bridge.MulticastAspectAttribute',{$extend:[Bridge.AspectAttribute]});

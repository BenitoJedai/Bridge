...
return part;});},parse:function(value,provider){return this.parseExact(value,null,provider);},parseExact:function(str,format,provider,silent){if(!format){format=["G","g","F","f","D","d","R","r","s","U","u","O","o","Y","y","M","m","T","t"];}
...
var df=(provider||Bridge.CultureInfo.getCurrentCulture()).getFormat(Bridge.DateTimeFormatInfo),am=df.amDesignator,pm=df.pmDesignator,int=0,index=0,i,c,token,year=0,month=1,date=1,hh=0,mm=0,ss=0,ff=0,tt="",zzh=0,zzm=0,zzi,sign,neg,names,name,invalid=false;if(str==null){throw new Bridge.ArgumentNullException("str");}

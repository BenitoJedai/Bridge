...
var Bridge={global:(function(){return this;})(),emptyFn:function(){},copy:function(to,from,keys,toIf){if(typeof keys==='string'){keys=keys.split(/[,;\s]+/);}
...
return scope;},ready:function(fn){if(typeof Bridge.global.jQuery!=='undefined'){$(fn);}else{Bridge.on('DOMContentLoaded',document,fn);}},on:function(event,elem,fn){var listenHandler=function(e){var ret=fn.apply(this,arguments);if(ret===false){e.stopPropagation();e.preventDefault();}
return(ret);}
...
if(config.init){config.init.apply(this,arguments);}};},define:function(className,prop){var extend=prop.$extends,statics=prop.$statics||prop.statics,base=extend?extend[0].prototype:this.prototype,prototype,nameParts,scope=prop.$scope||Bridge.global,i,v,ctorCounter,isCtor,name;if(Bridge.isFunction(extend)){extend=null;}

...
return str.match(suffix+"$")!==null;},contains:function(str,value){return str.indexOf(value)>-1;}};Bridge.String=string;})();
...
if(config.init){config.init.apply(this,arguments);}};},define:function(className,prop){var extend=prop.$inherits||prop.inherits,statics=prop.$statics||prop.statics,base=extend?extend[0].prototype:this.prototype,prototype,nameParts,scope=prop.$scope||Bridge.global,i,v,ctorCounter,isCtor,name;if(Bridge.isFunction(extend)){extend=null;}
else if(prop.$inherits){delete prop.$inherits;}

...
(function(){var core={emptyFn:function(){},copy:function(to,from,keys,toIf){if(typeof keys==='string'){keys=keys.split(/[,;\s]+/);}
...
return str.match(suffix+"$")!==null;}};Bridge.String=string;})();

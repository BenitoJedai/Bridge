...
return scope;},ready:function(fn){if(typeof Bridge.global.jQuery!=='undefined'){$(fn);}else{if(document.readyState=="complete"||document.readyState=="loaded"){fn();}
else{Bridge.on('DOMContentLoaded',document,fn);}}},on:function(event,elem,fn){var listenHandler=function(e){var ret=fn.apply(this,arguments);if(ret===false){e.stopPropagation();e.preventDefault();}
return(ret);}
